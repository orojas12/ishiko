...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid max-h-full max-w-lg lg:max-w-2xl w-full overflow-auto translate-x-[-50%] \
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse lg:flex-row lg:justify-end gap-3 lg:items-end",
      className
    )}
    {...props}
  />
